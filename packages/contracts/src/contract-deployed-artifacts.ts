...
export const getDeployedContractArtifact = (
  name: string,
  network: string
): any => {
  return {
    goerli__Lib_AddressManager,
    goerli__mockOVM_BondManager,
    goerli__OVM_CanonicalTransactionChain,
    goerli__OVM_ChainStorageContainer_CTC_batches,
    goerli__OVM_ChainStorageContainer_CTC_queue,
    goerli__OVM_ChainStorageContainer_SCC_batches,
    goerli__OVM_ExecutionManager,
    goerli__OVM_FraudVerifier,
    goerli__OVM_L1CrossDomainMessenger,
    goerli__OVM_L1ETHGateway,
    goerli__OVM_L1MultiMessageRelayer,
    goerli__OVM_SafetyChecker,
    goerli__OVM_StateCommitmentChain,
    goerli__OVM_StateManagerFactory,
    goerli__OVM_StateTransitionerFactory,
    goerli__Proxy__OVM_L1CrossDomainMessenger,
    goerli__Proxy__OVM_L1ETHGateway,
    goerli__Proxy__OVM_L1StandardBridge,
    kovan__Lib_AddressManager,
    kovan__mockOVM_BondManager,
    kovan__OVM_CanonicalTransactionChain,
    kovan__OVM_ChainStorageContainer_CTC_batches,
    kovan__OVM_ChainStorageContainer_CTC_queue,
    kovan__OVM_ChainStorageContainer_SCC_batches,
    kovan__OVM_ExecutionManager,
    kovan__OVM_FraudVerifier,
    kovan__OVM_L1CrossDomainMessenger,
    kovan__OVM_L1MultiMessageRelayer,
    kovan__OVM_SafetyChecker,
    kovan__OVM_StateCommitmentChain,
    kovan__OVM_StateManagerFactory,
    kovan__OVM_StateTransitionerFactory,
    kovan__Proxy__OVM_L1CrossDomainMessenger,
    kovan__Proxy__OVM_L1StandardBridge,
    mainnet__Lib_AddressManager,
    mainnet__mockOVM_BondManager,
    mainnet__OVM_CanonicalTransactionChain,
    mainnet__OVM_ChainStorageContainer_CTC_batches,
    mainnet__OVM_ChainStorageContainer_CTC_queue,
    mainnet__OVM_ChainStorageContainer_SCC_batches,
    mainnet__OVM_ExecutionManager,
    mainnet__OVM_FraudVerifier,
    mainnet__OVM_L1CrossDomainMessenger,
    mainnet__OVM_L1MultiMessageRelayer,
    mainnet__OVM_SafetyChecker,
    mainnet__OVM_StateCommitmentChain,
    mainnet__OVM_StateManagerFactory,
    mainnet__OVM_StateTransitionerFactory,
    mainnet__Proxy__OVM_L1CrossDomainMessenger,
    mainnet__Proxy__OVM_L1StandardBridge,
    optimistic_kovan__OVM_GasPriceOracle,
    optimistic_kovan__OVM_L2StandardTokenFactory,
